		...
		if galao or output.stock > amount then
			...
			if money >= price then
				...
				if galao then
					...
					TriggerClientEvent("gas_station:Notify",source,"sucesso","Payer <b>$"..price.." </b> pour le <b>Galão</b>.",8000)
				else
					...
					TriggerClientEvent("gas_station:Notify",source,"sucesso","Paye <b>$"..price.." </b> in "..amount.." litres.",8000)
				end
			else
			...
			TriggerClientEvent('vrp_legacyfuel2:insuficiente',source,vehicle,fuel2)
			TriggerClientEvent("gas_station:Notify",source,"negado","Stock de combustible insuffisant (Max: "..output.stock.." litres).",8000)
		end
	end
end)
